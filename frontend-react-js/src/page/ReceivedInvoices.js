...
class ReceivedInvoices extends Component {
		...
		return (
			<div>
				<div className="float-right">
					<Button color="success" tag={Link} to="/received-invoice/new">{t('Add received invoice')}</Button>
				</div>
				<h2>{t('Received invoices')}</h2>
...
export default withTranslation()(ReceivedInvoices);
